...
public:
	void fill() {
		std::string sectionName("ForceProperties");

		auto ratioToStableLength = this->template load<double>(sectionName, "ratioToStableLength");
		auto rigidity = this->template load<double>(sectionName, "rigidity");
