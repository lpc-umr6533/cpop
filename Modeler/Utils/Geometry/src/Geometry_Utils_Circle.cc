	...
	namespace Geometry
	{
		namespace Circle
		{
			...
			Point_2 getMediumPointOnCircle(Point_2 circleOrigin, double, Point_2 a, Point_2 b)
			{
				...
				return Point_2(res.x() + circleOrigin.x(), res.y() + circleOrigin.y());
			}
			...
			////////////////////////////////////////////////////////////////////////////////////////
	        int lineCircleIntersection(Point_2 segStart, Point_2 segEnd,
			...
			/// \param intersection2 The second potential intersection point
			////////////////////////////////////////////////////////////////////////////////////////
			int segmentCircleIntersection(Point_2 segStart, Point_2 segEnd,
			...
			Point_2 getSpotOnDisc(double radius, Point_2 center, double internalRadius)
			{
				...
				return Point_2(p.x()+center.x(), p.y()+center.y());
			}
