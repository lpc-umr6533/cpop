...
#include "../geometry/solid/G4Box.hh" ///#include "G4Box.hh"
// #include "G4Cons.hh"
...
// #include "G4Hype.hh"
#include "../geometry/solid/G4Orb.hh" //#include "G4Orb.hh"
// #include "G4Para.hh"
...
// #include "../geometry/solid/G4Sphere.hh" // #include "G4Sphere.hh"
// #include "G4SubtractionSolid.hh"
#include "../geometry/solid/specific/G4TessellatedSolid.hh" //#include "G4TessellatedSolid.hh"
// #include "../geometry/solid/specific/G4Tet.hh"              ///#include "G4Tet.hh"
// #include "G4Torus.hh"
// #include "G4Trap.hh"
// #include "G4Trd.hh"
///#include "G4Tubs.hh"
                 ...
                 const G4TessellatedSolid* const tessellated)
{
   ...
   for (size_t i=0;i<NumFacets;i++)
   {
      ...
      else
      {
        ...
        std::string mess = "G4GDMLWriteSolids::TessellatedWrite() InvalidSetup FatalException Facet should contain 3 or 4 vertices!";
        InformationSystemManager::getInstance()->Message(InformationSystemManager::FATAL_ERROR_MES, mess, "GDML Parser");
      } 
