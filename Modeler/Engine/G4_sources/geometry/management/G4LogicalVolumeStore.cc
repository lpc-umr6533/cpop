...
///                 JustWarning, "Volume NOT found in store !");
      std::string mess = "G4LogicalVolumeStore::GetVolume() InvalidQuery JustWarning Volume NOT found in store !";
      InformationSystemManager::getInstance()->Message(InformationSystemManager::FATAL_ERROR_MES, mess, "LogicalVolume");
  }
  return 0;
}
