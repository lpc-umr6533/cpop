#ifndef HOMOGENEOUSSOURCEMESSENGER_HH
#define HOMOGENEOUSSOURCEMESSENGER_HH
...
class HomogeneousSourceMessenger : public MessengerBase
{
public:
    HomogeneousSourceMessenger(HomogeneousSource *source);
    ~HomogeneousSourceMessenger() = default;

    virtual void BuildCommands(G4String base) override;
    virtual void SetNewValue(G4UIcommand * command , G4String newValue) override;

private:
    HomogeneousSource* source_;
...
#endif // HOMOGENEOUSSOURCEMESSENGER_HH
