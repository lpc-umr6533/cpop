/****************************************************************************
** Meta object code from reading C++ file 'SimulationManager.hh'
**
...
#include <memory>
#include "../../../../../source/MAS/Simulation/include/SimulationManager.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SimulationManager.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 18, 13), // "si_stepRunned"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "SimulationManager\0si_stepRunned\0"
};
...
void SimulationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->si_stepRunned(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SimulationManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationManager::si_stepRunned)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SimulationManager::si_stepRunned()
{
